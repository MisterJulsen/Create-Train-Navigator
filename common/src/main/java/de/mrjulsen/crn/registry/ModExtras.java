...
public class ModExtras {
    ...
    public static final RegistryEntry<AdvancedDisplaySource> ADVANCED_DISPLAY_SOURCE = CreateRailwaysNavigator.REGISTRATE.displaySource("advanced_display", AdvancedDisplaySource::new)
            .register();
