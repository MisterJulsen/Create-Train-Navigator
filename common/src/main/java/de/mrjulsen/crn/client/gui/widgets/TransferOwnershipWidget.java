...
public class TransferOwnershipWidget<T extends GuiEventListener & Widget & NarratableEntry> extends DLWidgetContainer {
    ...
    public void renderMainLayer(Graphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if (selectionBox != null) {
            ...
            graphics.poseStack().translate(selectionBox.x, selectionBox.y + selectionBox.getHeight() + 8, 0);
            graphics.poseStack().scale(0.75f, 0.75f, 0.75f);        
            DLUtils.doIfNotNull(messageLabel, x -> x.renderLeftAligned(graphics.poseStack(), 0, 0, font.lineHeight, 0xFFFFFFFF));
