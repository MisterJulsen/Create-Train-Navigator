...
public static final int DEFAULT_HEIGHT = 20;
    ...
    public void renderMainLayer(Graphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        GuiUtils.drawString(graphics, font, x() + 5, this.y() + (20 - 8) / 2, this.getMessage(), j, ETextAlignment.LEFT, false);
    ...
    protected void renderDescriptionTooltip(Graphics graphics, int mouseX, int mouseY, float partialTicks) {
        DLUtils.doIfNotNull(parent.getTooltips(), t -> {            
            ...
            for (int i = 0; i < t.size(); i++) {
                ...
                GuiUtils.drawString(graphics, font, 12, 16 + (font.lineHeight + 2) * i, line, DragonLib.NATIVE_BUTTON_FONT_COLOR_ACTIVE, ETextAlignment.LEFT, false);
            }
