...
public class FlyoutDepartureInWidget extends AbstractFlyoutWidget {
    ...
    public FlyoutDepartureInWidget(DLWindowManager manager, DLGuiComponent parentComponent, FlyoutPointer pointer, ColorShade pointerShade, UserSettings settings, Supplier<UserSetting<Integer>> getUserSetting) {
