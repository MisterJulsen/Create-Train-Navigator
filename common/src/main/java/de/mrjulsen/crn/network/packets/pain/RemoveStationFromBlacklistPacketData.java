...
public class RemoveStationFromBlacklistPacketData {
    ...
    public static Response handle(Request packet, NetworkPacketContext context) {
        ...
        GlobalSettings.getInstance().removeStationFromBlacklist(packet.name);
        return new Response(GlobalSettings.getInstance().getAllBlacklistedStations());
    }
