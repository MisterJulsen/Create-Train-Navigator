...
/**
 * Asks the backend for a train's current state, optionally together with its whole journey.
 * <p>
 * The journey is only sent when asked for, since a caller polling for live delays needs it on every
 * request while a caller showing the full run needs it exactly once.
 */
