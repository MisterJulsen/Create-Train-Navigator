...
public class UpdateStationTagEntryPacketData {
    ...
    public static class Request extends NetworkPacketData {
        ...
        protected void read(CompoundTag nbt) {
            ...
            this.info = StationInfo.fromNbt(nbt.getCompound(NBT_INFO));
        }
    }
