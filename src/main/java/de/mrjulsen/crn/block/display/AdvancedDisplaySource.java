...
public class AdvancedDisplaySource extends DisplaySource {
	...
	public void initConfigurationWidgets(DisplayLinkContext context, ModularGuiLineBuilder builder, boolean isFirstLine) {
		...
		builder.addScrollInput(0, 40, (si, l) -> {
			si.titled(Utils.translate("gui.createrailwaysnavigator.display_source.advanced_display.train_name_width"))
				.addHint(Utils.translate("gui.createrailwaysnavigator.display_source.advanced_display.train_name_width.description"))
				.withRange(0, 65)
				.withShiftStep(4);
			si.setState(16);
			l.withSuffix("px");
		...
		builder.addScrollInput(44, 40, (si, l) -> {
			si.titled(Utils.translate("gui.createrailwaysnavigator.display_source.advanced_display.platform_width"))
				.addHint(Utils.translate("gui.createrailwaysnavigator.display_source.advanced_display.platform_width.description"))
				.withRange(-1, 65)
				.withShiftStep(4);				
			si.setState(16);
			l.withSuffix("px");
